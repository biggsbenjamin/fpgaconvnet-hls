...
NETWORK=branchynet
MODEL_PATH=$FPGACONVNET_OPTIMISER/examples/models/io-match_trained_norm_no-bias.onnx
WEIGHTS_PATH=""
PARTITION_INFO_PATH=branchynet-stage-2.json
IMAGE_PATH=input_example.png
#IMAGE_PATH=random_input_example.png
