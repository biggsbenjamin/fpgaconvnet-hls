...
int main()
{
    ...
    stream_t(data_t) out_correct[SQUEEZE_LAYER_COARSE_OUT];

    // test images
    static data_t test_in[DIVIDE(SQUEEZE_LAYER_CHANNELS,SQUEEZE_LAYER_COARSE_IN)*SQUEEZE_LAYER_ROWS*SQUEEZE_LAYER_COLS][SQUEEZE_LAYER_COARSE_IN];
    static data_t test_out[DIVIDE(SQUEEZE_LAYER_CHANNELS,SQUEEZE_LAYER_COARSE_OUT)*SQUEEZE_LAYER_ROWS_OUT*SQUEEZE_LAYER_COLS_OUT][SQUEEZE_LAYER_COARSE_OUT];
