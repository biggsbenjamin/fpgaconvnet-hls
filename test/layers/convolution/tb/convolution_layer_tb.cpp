...
int main()
{
    ...
    stream_t(data_t) out_correct[CONVOLUTION_LAYER_COARSE_OUT*CONVOLUTION_LAYER_COARSE_GROUP];

    // test images
    static data_t test_in[DIVIDE(CONVOLUTION_LAYER_CHANNELS,CONVOLUTION_LAYER_COARSE_IN*CONVOLUTION_LAYER_COARSE_GROUP)*CONVOLUTION_LAYER_ROWS*CONVOLUTION_LAYER_COLS][CONVOLUTION_LAYER_COARSE_IN*CONVOLUTION_LAYER_COARSE_GROUP];
    static data_t test_out[DIVIDE(CONVOLUTION_LAYER_CHANNELS_OUT,CONVOLUTION_LAYER_COARSE_OUT*CONVOLUTION_LAYER_COARSE_GROUP)*rows_out*cols_out][CONVOLUTION_LAYER_COARSE_OUT*CONVOLUTION_LAYER_COARSE_GROUP];
