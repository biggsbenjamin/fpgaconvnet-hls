...
int main()
{
    ...
    // test images
    static data_t test_in[CHANNELS_3D(CONVOLUTION_LAYER_CHANNELS,CONVOLUTION_LAYER_COARSE_IN)*CONVOLUTION_LAYER_ROWS*CONVOLUTION_LAYER_COLS][CONVOLUTION_LAYER_COARSE_IN];
    static data_t test_out[CHANNELS_3D(CONVOLUTION_LAYER_CHANNELS_OUT,CONVOLUTION_LAYER_COARSE_OUT)*rows_out*cols_out][CONVOLUTION_LAYER_COARSE_OUT];

    // load input
    load_data<
        CHANNELS_3D(CONVOLUTION_LAYER_CHANNELS,CONVOLUTION_LAYER_COARSE_IN)*CONVOLUTION_LAYER_ROWS*CONVOLUTION_LAYER_COLS,
        CONVOLUTION_LAYER_COARSE_IN
    >(input_path,test_in);

    // load output
    load_data<
        CHANNELS_3D(CONVOLUTION_LAYER_CHANNELS_OUT,CONVOLUTION_LAYER_COARSE_OUT)*rows_out*cols_out,
