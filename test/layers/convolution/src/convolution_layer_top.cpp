...
#pragma HLS DATAFLOW
    ...
    const static convolution_layer_weight_t weights[CONVOLUTION_LAYER_COARSE_IN*CONVOLUTION_LAYER_COARSE_GROUP][CONVOLUTION_LAYER_COARSE_OUT][DIVIDE(CONVOLUTION_LAYER_WEIGHTS,CONVOLUTION_LAYER_COARSE_IN*CONVOLUTION_LAYER_COARSE_GROUP*CONVOLUTION_LAYER_COARSE_OUT*CONVOLUTION_LAYER_KERNEL_SIZE_X*CONVOLUTION_LAYER_KERNEL_SIZE_Y)][CONVOLUTION_LAYER_KERNEL_SIZE_X][CONVOLUTION_LAYER_KERNEL_SIZE_Y] = {
        #include "weights.csv"
    };
